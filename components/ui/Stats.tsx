...
const stats = [
  {
    ...
    sublabel: "qui génèrent du chiffre",
  },
  {
    icon: "💰",
    value: 1,
    suffix: "M€+",
    label: "Générés par nos membres",
    sublabel: "chiffre cumulé",
  },
  {
    icon: "🚀",
    value: 90,
    suffix: "j",
    label: "Pour voir tes premiers résultats",
    sublabel: "accompagnement jusqu'au succès",
  },
];
...
function StatCard({
  ...
  return (
    ...
    >
      <span style={{ fontSize: 36 }} role="img" aria-hidden="true">
        {stat.icon}
      </span>
