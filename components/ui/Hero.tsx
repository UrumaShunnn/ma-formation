...
export default function Hero() {
  return (
    <section
      id="presentation"
      style={{ position: "relative", minHeight: "100vh", paddingTop: 100, paddingBottom: 64, background: "#0A0A0A", display: "flex", alignItems: "center", overflow: "hidden" }}
    >
      {/* Grain */}
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-4 md:px-6 flex flex-col items-center text-center gap-8">
        ...
        {/* H1 */}
        <h1 className="text-3xl md:text-5xl lg:text-6xl" style={{ fontFamily: "Syne, sans-serif", fontWeight: 900, lineHeight: 1.1, letterSpacing: "-0.02em", animation: "fadeInUp 0.6s ease 100ms both" }}>
        ...
        <div className="w-full max-w-3xl mx-auto px-0 md:px-0" style={{ animation: "fadeInUp 0.6s ease 300ms both" }}>
          <div className="w-full aspect-video" style={{ position: "relative", borderRadius: 16, overflow: "hidden", border: "1px solid rgba(124,58,237,0.3)", boxShadow: "0 0 60px rgba(124,58,237,0.2)" }}>
            {YOUTUBE_VIDEO_ID ? (
              ...
              <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg, #111111 0%, #1A1A1A 100%)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16 }} role="img" aria-label="Vidéo de présentation">
        ...
        {/* Checklist */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 w-full max-w-xl" style={{ animation: "fadeInUp 0.6s ease 500ms both" }}>
