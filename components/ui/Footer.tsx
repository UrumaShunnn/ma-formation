...
const socials = [
  { label: "Instagram", href: "https://www.instagram.com/portostdk", Icon: InstagramIcon },
  { label: "TikTok", href: "https://www.tiktok.com/@portos_tdk", Icon: TikTokIcon },
  { label: "YouTube", href: "https://youtube.com/@portostdk", Icon: YouTubeIcon },
];
...
export default function Footer() {
  return (
    <footer style={{ width: "100%", paddingTop: 48, paddingBottom: 32, background: "transparent", borderTop: "1px solid #1A1A1A", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 40, marginBottom: 48 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <p style={{ color: "#6B7280", fontSize: 14, lineHeight: 1.7, margin: 0 }}>
              L&apos;accélérateur e-commerce qui t&apos;emmène du zéro à tes premiers chiffres d&apos;affaires en 30 jours.
            </p>
