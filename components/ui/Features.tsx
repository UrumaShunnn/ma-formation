    ...
    >
      ...
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
          <rect x="3" y="3" width="18" height="14" rx="2" stroke="#8B5CF6" strokeWidth="1.5" />
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
          ...
          <div style={blockStyle}>
            ...
            >
              ...
              <div ref={block1Img.ref} style={block1Img.style}>
          ...
          <div style={blockStyle}>
            ...
            >
              <div ref={block2Img.ref} style={block2Img.style}>
                <ImagePlaceholder label="Screenshot communauté" />
              </div>
              <div ref={block2Text.ref} style={block2Text.style}>
                <h3
                  style={{
                    fontFamily: "Syne, sans-serif",
                    fontWeight: 700,
          ...
          <div style={blockStyle}>
            ...
            >
              ...
              <div ref={block3Img.ref} style={block3Img.style}>
                <ImagePlaceholder label="Screenshot ressources" />
              </div>
            </div>
          </div>

          {/* ── Bloc 4 : pleine largeur, grid 2x2 ── */}
          <div ref={block4.ref} style={{ ...blockStyle, ...block4.style }}>
            <h3
              style={{
                fontFamily: "Syne, sans-serif",
                fontWeight: 700,
...
function BonusCard({ card }: { card: (typeof bonusCards)[number] }) {
  ...
  return (
    <div
      ...
      style={{
        background: hovered ? "rgba(124,58,237,0.08)" : "#1A1A1A",
        border: `1px solid ${hovered ? "rgba(124,58,237,0.4)" : "#2A2A2A"}`,
        borderRadius: 12,
        padding: 24,
    ...
    >
      <span style={{ fontSize: 28, display: "block", marginBottom: 12 }} role="img" aria-hidden="true">
        {card.icon}
      </span>
      <p
        style={{
