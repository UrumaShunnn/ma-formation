...
function ImagePlaceholder({ label }: { label: string }) {
  return (
    <div style={{ width: "100%", aspectRatio: "4/3", background: "linear-gradient(135deg, #1A1A1A 0%, #111111 100%)", borderRadius: 12, border: "1px solid rgba(124,58,237,0.25)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 12, overflow: "hidden", position: "relative" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          <div className="p-6 md:p-12" style={{ background: "#111111", borderRadius: 16, border: "1px solid #2A2A2A" }}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              ...
              <div ref={block1Img.ref} style={block1Img.style}><ImagePlaceholder label="Screenshot plateforme formation" /></div>
            </div>
          </div>
          ...
          <div className="p-6 md:p-12" style={{ background: "#111111", borderRadius: 16, border: "1px solid #2A2A2A" }}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              ...
              <div ref={block3Img.ref} style={block3Img.style}><ImagePlaceholder label="Screenshot ressources" /></div>
            </div>
          </div>
